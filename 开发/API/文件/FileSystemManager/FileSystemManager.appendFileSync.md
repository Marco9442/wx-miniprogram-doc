# [#](#FileSystemManager-appendFileSync-string-filePath-string-ArrayBuffer-data-string-encoding) FileSystemManager.appendFileSync(string filePath, string|ArrayBuffer data, string encoding)
