# [#](#FileSystemManager-writeFileSync-string-filePath-string-ArrayBuffer-data-string-encoding) FileSystemManager.writeFileSync(string filePath, string|ArrayBuffer data, string encoding)
