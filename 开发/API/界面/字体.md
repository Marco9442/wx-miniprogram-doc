# [#](#wx-loadFontFace-Object-object) wx.loadFontFace(Object object)
...
#### [#](#object-complete-回调函数) object.complete 回调函数

##### [#](#参数-4) 参数

###### [#](#Object-res-3) Object res
...
7. [2.10.0](../../../framework/compatibility.html) 以前仅在调用页面生效。[2.10.0](../../../framework/compatibility.html) 起支持全局生效，需在 `app.js` 中调用。
8. [3.7.9](../../../framework/compatibility.html) 以前 scopes 默认值为 webview。[3.7.9](../../../framework/compatibility.html) 起默认全选。
9. [3.7.9](../../../framework/compatibility.html) 开始 source 支持传入 Data URL。
