# [#](#wx-getExtConfig-Object-object) wx.getExtConfig(Object object)
...
1. 本接口暂时无法通过 [wx.canIUse](../base/wx.canIUse.html) 判断是否兼容，开发者需要自行判断 [wx.getExtConfig](wx.getExtConfig.html) 是否存在来兼容
