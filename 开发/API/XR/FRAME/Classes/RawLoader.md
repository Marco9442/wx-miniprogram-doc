[xr-frame](./../) / [Exports](./../modules.html) / RawLoader

# [#](#Class-RawLoader) Class: RawLoader

原始数据的加载器。

## [#](#Hierarchy) Hierarchy

- [`AssetLoader`](./AssetLoader.html)<`string` | `ArrayBuffer`, [`IRawLoaderOptions`](./../interfaces/IRawLoaderOptions.html)>
...
- [constructor](./RawLoader.html#constructor)

### [#](#Properties) Properties

- [schema](./RawLoader.html#schema)

### [#](#Accessors) Accessors

- [scene](./RawLoader.html#scene)

### [#](#Methods) Methods

- [cancel](./RawLoader.html#cancel)
- [getBuiltin](./RawLoader.html#getBuiltin)
- [load](./RawLoader.html#load)
- [release](./RawLoader.html#release)
...
▸ **getBuiltin**(): { `assetId`: `string` ; `options`: [`IRawLoaderOptions`](./../interfaces/IRawLoaderOptions.html) ; `src`: `string` }[]
...
{ `assetId`: `string` ; `options`: [`IRawLoaderOptions`](./../interfaces/IRawLoaderOptions.html) ; `src`: `string` }[]
