[xr-frame](./../) / [Exports](./../modules.html) / XRGLTF

# [#](#Class-XRGLTF) Class: XRGLTF

标签为`xr-gltf`。
不能在这个标签内放置子标签。

默认组件见[GLTFDefaultComponents](./../modules.html#GLTFDefaultComponents)，属性映射见[GLTFDataMapping](./../modules.html#GLTFDataMapping)。
...
- [constructor](./XRGLTF.html#constructor)

### [#](#Properties) Properties

- [dataMapping](./XRGLTF.html#dataMapping)
- [defaultComponents](./XRGLTF.html#defaultComponents)
- [TYPE](./XRGLTF.html#TYPE)

### [#](#Accessors) Accessors

- [event](./XRGLTF.html#event)
- [id](./XRGLTF.html#id)
- [inXML](./XRGLTF.html#inXML)
- [name](./XRGLTF.html#name)
- [parent](./XRGLTF.html#parent)
- [scene](./XRGLTF.html#scene)

### [#](#Methods) Methods

- [addChild](./XRGLTF.html#addChild)
- [addComponent](./XRGLTF.html#addComponent)
- [dfs](./XRGLTF.html#dfs)
- [getChildAtIndex](./XRGLTF.html#getChildAtIndex)
- [getChildByClass](./XRGLTF.html#getChildByClass)
- [getChildByFilter](./XRGLTF.html#getChildByFilter)
- [getChildByName](./XRGLTF.html#getChildByName)
- [getChildrenByFilter](./XRGLTF.html#getChildrenByFilter)
- [getChildrenByName](./XRGLTF.html#getChildrenByName)
- [getComponent](./XRGLTF.html#getComponent)
- [release](./XRGLTF.html#release)
- [removeChild](./XRGLTF.html#removeChild)
- [removeComponent](./XRGLTF.html#removeComponent)
- [setAttribute](./XRGLTF.html#setAttribute)
- [setId](./XRGLTF.html#setId)
...
[XRShadow](./XRShadow.html).[constructor](./XRShadow.html#constructor)
...
[XRShadow](./XRShadow.html).[dataMapping](./XRShadow.html#dataMapping)
...
[XRShadow](./XRShadow.html).[defaultComponents](./XRShadow.html#defaultComponents)
...
[XRShadow](./XRShadow.html).[TYPE](./XRShadow.html#TYPE)
...
[XRShadow](./XRShadow.html).[addChild](./XRShadow.html#addChild)
...
[XRShadow](./XRShadow.html).[addComponent](./XRShadow.html#addComponent)
...
[XRShadow](./XRShadow.html).[dfs](./XRShadow.html#dfs)
...
[XRShadow](./XRShadow.html).[getChildAtIndex](./XRShadow.html#getChildAtIndex)
...
[XRShadow](./XRShadow.html).[getChildByClass](./XRShadow.html#getChildByClass)
...
[XRShadow](./XRShadow.html).[getChildByFilter](./XRShadow.html#getChildByFilter)
...
[XRShadow](./XRShadow.html).[getChildByName](./XRShadow.html#getChildByName)
...
[XRShadow](./XRShadow.html).[getChildrenByFilter](./XRShadow.html#getChildrenByFilter)
...
[XRShadow](./XRShadow.html).[getChildrenByName](./XRShadow.html#getChildrenByName)
...
[XRShadow](./XRShadow.html).[getComponent](./XRShadow.html#getComponent)
...
[XRShadow](./XRShadow.html).[release](./XRShadow.html#release)
...
[XRShadow](./XRShadow.html).[removeChild](./XRShadow.html#removeChild)
...
[XRShadow](./XRShadow.html).[removeComponent](./XRShadow.html#removeComponent)
...
[XRShadow](./XRShadow.html).[setAttribute](./XRShadow.html#setAttribute)
...
[XRShadow](./XRShadow.html).[setId](./XRShadow.html#setId)
