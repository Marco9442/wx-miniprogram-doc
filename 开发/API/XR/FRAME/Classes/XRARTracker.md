[xr-frame](./../) / [Exports](./../modules.html) / XRARTracker

# [#](#Class-XRARTracker) Class: XRARTracker

标签为`xr-ar-tracker`。

默认组件见[ARTrackerDefaultComponents](./../modules.html#ARTrackerDefaultComponents)，属性映射见[ARTrackerDataMapping](./../modules.html#ARTrackerDataMapping)。
...
- [constructor](./XRARTracker.html#constructor)

### [#](#Properties) Properties

- [dataMapping](./XRARTracker.html#dataMapping)
- [defaultComponents](./XRARTracker.html#defaultComponents)
- [TYPE](./XRARTracker.html#TYPE)

### [#](#Accessors) Accessors

- [event](./XRARTracker.html#event)
- [id](./XRARTracker.html#id)
- [inXML](./XRARTracker.html#inXML)
- [name](./XRARTracker.html#name)
- [parent](./XRARTracker.html#parent)
- [scene](./XRARTracker.html#scene)

### [#](#Methods) Methods

- [addChild](./XRARTracker.html#addChild)
- [addComponent](./XRARTracker.html#addComponent)
- [dfs](./XRARTracker.html#dfs)
- [getChildAtIndex](./XRARTracker.html#getChildAtIndex)
- [getChildByClass](./XRARTracker.html#getChildByClass)
- [getChildByFilter](./XRARTracker.html#getChildByFilter)
- [getChildByName](./XRARTracker.html#getChildByName)
- [getChildrenByFilter](./XRARTracker.html#getChildrenByFilter)
- [getChildrenByName](./XRARTracker.html#getChildrenByName)
- [getComponent](./XRARTracker.html#getComponent)
- [release](./XRARTracker.html#release)
- [removeChild](./XRARTracker.html#removeChild)
- [removeComponent](./XRARTracker.html#removeComponent)
- [setAttribute](./XRARTracker.html#setAttribute)
- [setId](./XRARTracker.html#setId)
