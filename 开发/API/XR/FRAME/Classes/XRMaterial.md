[xr-frame](./../) / [Exports](./../modules.html) / XRMaterial

# [#](#Class-XRMaterial) Class: XRMaterial

标签为`xr-asset-material`。

默认组件见[AssetMaterialDefaultComponents](./../modules.html#AssetMaterialDefaultComponents)，属性映射见[AssetMaterialDataMapping](./../modules.html#AssetMaterialDataMapping)。
...
- [constructor](./XRMaterial.html#constructor)

### [#](#Properties) Properties

- [dataMapping](./XRMaterial.html#dataMapping)
- [defaultComponents](./XRMaterial.html#defaultComponents)
- [TYPE](./XRMaterial.html#TYPE)

### [#](#Accessors) Accessors

- [event](./XRMaterial.html#event)
- [id](./XRMaterial.html#id)
- [inXML](./XRMaterial.html#inXML)
- [name](./XRMaterial.html#name)
- [parent](./XRMaterial.html#parent)
- [scene](./XRMaterial.html#scene)

### [#](#Methods) Methods

- [addChild](./XRMaterial.html#addChild)
- [addComponent](./XRMaterial.html#addComponent)
- [dfs](./XRMaterial.html#dfs)
- [getChildAtIndex](./XRMaterial.html#getChildAtIndex)
- [getChildByClass](./XRMaterial.html#getChildByClass)
- [getChildByFilter](./XRMaterial.html#getChildByFilter)
- [getChildByName](./XRMaterial.html#getChildByName)
- [getChildrenByFilter](./XRMaterial.html#getChildrenByFilter)
- [getChildrenByName](./XRMaterial.html#getChildrenByName)
- [getComponent](./XRMaterial.html#getComponent)
- [release](./XRMaterial.html#release)
- [removeChild](./XRMaterial.html#removeChild)
- [removeComponent](./XRMaterial.html#removeComponent)
- [setAttribute](./XRMaterial.html#setAttribute)
- [setId](./XRMaterial.html#setId)
