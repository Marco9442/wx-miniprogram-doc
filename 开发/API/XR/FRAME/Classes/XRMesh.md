[xr-frame](./../) / [Exports](./../modules.html) / XRMesh

# [#](#Class-XRMesh) Class: XRMesh

标签为`xr-mesh`。

默认组件见[MeshDefaultComponents](./../modules.html#MeshDefaultComponents)，属性映射见[MeshDataMapping](./../modules.html#MeshDataMapping)。
...
- [constructor](./XRMesh.html#constructor)

### [#](#Properties) Properties

- [dataMapping](./XRMesh.html#dataMapping)
- [defaultComponents](./XRMesh.html#defaultComponents)
- [TYPE](./XRMesh.html#TYPE)

### [#](#Accessors) Accessors

- [event](./XRMesh.html#event)
- [id](./XRMesh.html#id)
- [inXML](./XRMesh.html#inXML)
- [name](./XRMesh.html#name)
- [parent](./XRMesh.html#parent)
- [scene](./XRMesh.html#scene)

### [#](#Methods) Methods

- [addChild](./XRMesh.html#addChild)
- [addComponent](./XRMesh.html#addComponent)
- [dfs](./XRMesh.html#dfs)
- [getChildAtIndex](./XRMesh.html#getChildAtIndex)
- [getChildByClass](./XRMesh.html#getChildByClass)
- [getChildByFilter](./XRMesh.html#getChildByFilter)
- [getChildByName](./XRMesh.html#getChildByName)
- [getChildrenByFilter](./XRMesh.html#getChildrenByFilter)
- [getChildrenByName](./XRMesh.html#getChildrenByName)
- [getComponent](./XRMesh.html#getComponent)
- [release](./XRMesh.html#release)
- [removeChild](./XRMesh.html#removeChild)
- [removeComponent](./XRMesh.html#removeComponent)
- [setAttribute](./XRMesh.html#setAttribute)
- [setId](./XRMesh.html#setId)
