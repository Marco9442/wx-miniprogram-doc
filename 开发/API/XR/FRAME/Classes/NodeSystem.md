[xr-frame](./../) / [Exports](./../modules.html) / NodeSystem
...
- [`Component`](./Component.html)<[`INodeSystemData`](./../interfaces/INodeSystemData.html)>
...
- [constructor](./NodeSystem.html#constructor)

### [#](#Events) Events

- [onAdd](./NodeSystem.html#onAdd)
- [onRelease](./NodeSystem.html#onRelease)
- [onRemove](./NodeSystem.html#onRemove)
- [onTick](./NodeSystem.html#onTick)
- [onUpdate](./NodeSystem.html#onUpdate)

### [#](#Properties) Properties

- [priority](./NodeSystem.html#priority)
- [schema](./NodeSystem.html#schema)
- [EVENTS](./NodeSystem.html#EVENTS)

### [#](#Accessors) Accessors

- [el](./NodeSystem.html#el)
- [scene](./NodeSystem.html#scene)
- [version](./NodeSystem.html#version)

### [#](#Methods) Methods

- [getData](./NodeSystem.html#getData)
- [setData](./NodeSystem.html#setData)
- [setDataOne](./NodeSystem.html#setDataOne)
...
▸ **getData**<`T`>(`key`): [`INodeSystemData`](./../interfaces/INodeSystemData.html)[`T`]
...
[`INodeSystemData`](./../interfaces/INodeSystemData.html)[`T`]
