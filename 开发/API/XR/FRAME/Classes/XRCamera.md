[xr-frame](./../) / [Exports](./../modules.html) / XRCamera

# [#](#Class-XRCamera) Class: XRCamera

标签为`xr-camera`。

默认组件见[CameraDefaultComponents](./../modules.html#CameraDefaultComponents)，属性映射见[CameraDataMapping](./../modules.html#CameraDataMapping)。
...
- [constructor](./XRCamera.html#constructor)

### [#](#Properties) Properties

- [dataMapping](./XRCamera.html#dataMapping)
- [defaultComponents](./XRCamera.html#defaultComponents)
- [TYPE](./XRCamera.html#TYPE)

### [#](#Accessors) Accessors

- [event](./XRCamera.html#event)
- [id](./XRCamera.html#id)
- [inXML](./XRCamera.html#inXML)
- [name](./XRCamera.html#name)
- [parent](./XRCamera.html#parent)
- [scene](./XRCamera.html#scene)

### [#](#Methods) Methods

- [addChild](./XRCamera.html#addChild)
- [addComponent](./XRCamera.html#addComponent)
- [dfs](./XRCamera.html#dfs)
- [getChildAtIndex](./XRCamera.html#getChildAtIndex)
- [getChildByClass](./XRCamera.html#getChildByClass)
- [getChildByFilter](./XRCamera.html#getChildByFilter)
- [getChildByName](./XRCamera.html#getChildByName)
- [getChildrenByFilter](./XRCamera.html#getChildrenByFilter)
- [getChildrenByName](./XRCamera.html#getChildrenByName)
- [getComponent](./XRCamera.html#getComponent)
- [release](./XRCamera.html#release)
- [removeChild](./XRCamera.html#removeChild)
- [removeComponent](./XRCamera.html#removeComponent)
- [setAttribute](./XRCamera.html#setAttribute)
- [setId](./XRCamera.html#setId)
