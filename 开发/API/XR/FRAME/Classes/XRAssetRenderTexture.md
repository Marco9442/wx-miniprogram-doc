[xr-frame](./../) / [Exports](./../modules.html) / XRAssetRenderTexture

# [#](#Class-XRAssetRenderTexture) Class: XRAssetRenderTexture

标签为`xr-asset-render-texture`。

默认组件见[AssetRenderTextureDefaultComponents](./../modules.html#AssetRenderTextureDefaultComponents)，属性映射见[AssetRenderTextureDataMapping](./../modules.html#AssetRenderTextureDataMapping)。
...
- [constructor](./XRAssetRenderTexture.html#constructor)

### [#](#Properties) Properties

- [dataMapping](./XRAssetRenderTexture.html#dataMapping)
- [defaultComponents](./XRAssetRenderTexture.html#defaultComponents)
- [TYPE](./XRAssetRenderTexture.html#TYPE)

### [#](#Accessors) Accessors

- [event](./XRAssetRenderTexture.html#event)
- [id](./XRAssetRenderTexture.html#id)
- [inXML](./XRAssetRenderTexture.html#inXML)
- [name](./XRAssetRenderTexture.html#name)
- [parent](./XRAssetRenderTexture.html#parent)
- [scene](./XRAssetRenderTexture.html#scene)

### [#](#Methods) Methods

- [addChild](./XRAssetRenderTexture.html#addChild)
- [addComponent](./XRAssetRenderTexture.html#addComponent)
- [dfs](./XRAssetRenderTexture.html#dfs)
- [getChildAtIndex](./XRAssetRenderTexture.html#getChildAtIndex)
- [getChildByClass](./XRAssetRenderTexture.html#getChildByClass)
- [getChildByFilter](./XRAssetRenderTexture.html#getChildByFilter)
- [getChildByName](./XRAssetRenderTexture.html#getChildByName)
- [getChildrenByFilter](./XRAssetRenderTexture.html#getChildrenByFilter)
- [getChildrenByName](./XRAssetRenderTexture.html#getChildrenByName)
- [getComponent](./XRAssetRenderTexture.html#getComponent)
- [release](./XRAssetRenderTexture.html#release)
- [removeChild](./XRAssetRenderTexture.html#removeChild)
- [removeComponent](./XRAssetRenderTexture.html#removeComponent)
- [setAttribute](./XRAssetRenderTexture.html#setAttribute)
- [setId](./XRAssetRenderTexture.html#setId)
