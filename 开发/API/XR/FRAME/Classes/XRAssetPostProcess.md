[xr-frame](./../) / [Exports](./../modules.html) / XRAssetPostProcess

# [#](#Class-XRAssetPostProcess) Class: XRAssetPostProcess

标签为`xr-asset-render-texture`。

默认组件见[AssetPostProcessDefaultComponents](./../modules.html#AssetPostProcessDefaultComponents)，属性映射见[AssetPostProcessDataMapping](./../modules.html#AssetPostProcessDataMapping)。
...
- [constructor](./XRAssetPostProcess.html#constructor)

### [#](#Properties) Properties

- [dataMapping](./XRAssetPostProcess.html#dataMapping)
- [defaultComponents](./XRAssetPostProcess.html#defaultComponents)
- [TYPE](./XRAssetPostProcess.html#TYPE)

### [#](#Accessors) Accessors

- [event](./XRAssetPostProcess.html#event)
- [id](./XRAssetPostProcess.html#id)
- [inXML](./XRAssetPostProcess.html#inXML)
- [name](./XRAssetPostProcess.html#name)
- [parent](./XRAssetPostProcess.html#parent)
- [scene](./XRAssetPostProcess.html#scene)

### [#](#Methods) Methods

- [addChild](./XRAssetPostProcess.html#addChild)
- [addComponent](./XRAssetPostProcess.html#addComponent)
- [dfs](./XRAssetPostProcess.html#dfs)
- [getChildAtIndex](./XRAssetPostProcess.html#getChildAtIndex)
- [getChildByClass](./XRAssetPostProcess.html#getChildByClass)
- [getChildByFilter](./XRAssetPostProcess.html#getChildByFilter)
- [getChildByName](./XRAssetPostProcess.html#getChildByName)
- [getChildrenByFilter](./XRAssetPostProcess.html#getChildrenByFilter)
- [getChildrenByName](./XRAssetPostProcess.html#getChildrenByName)
- [getComponent](./XRAssetPostProcess.html#getComponent)
- [release](./XRAssetPostProcess.html#release)
- [removeChild](./XRAssetPostProcess.html#removeChild)
- [removeComponent](./XRAssetPostProcess.html#removeComponent)
- [setAttribute](./XRAssetPostProcess.html#setAttribute)
- [setId](./XRAssetPostProcess.html#setId)
