[xr-frame](./../) / [Exports](./../modules.html) / XRLight

# [#](#Class-XRLight) Class: XRLight

标签为`xr-ar-tracker`。

默认组件见[LightDefaultComponents](./../modules.html#LightDefaultComponents)，属性映射见[LightDataMapping](./../modules.html#LightDataMapping)。
...
- [constructor](./XRLight.html#constructor)

### [#](#Properties) Properties

- [dataMapping](./XRLight.html#dataMapping)
- [defaultComponents](./XRLight.html#defaultComponents)
- [TYPE](./XRLight.html#TYPE)

### [#](#Accessors) Accessors

- [event](./XRLight.html#event)
- [id](./XRLight.html#id)
- [inXML](./XRLight.html#inXML)
- [name](./XRLight.html#name)
- [parent](./XRLight.html#parent)
- [scene](./XRLight.html#scene)

### [#](#Methods) Methods

- [addChild](./XRLight.html#addChild)
- [addComponent](./XRLight.html#addComponent)
- [dfs](./XRLight.html#dfs)
- [getChildAtIndex](./XRLight.html#getChildAtIndex)
- [getChildByClass](./XRLight.html#getChildByClass)
- [getChildByFilter](./XRLight.html#getChildByFilter)
- [getChildByName](./XRLight.html#getChildByName)
- [getChildrenByFilter](./XRLight.html#getChildrenByFilter)
- [getChildrenByName](./XRLight.html#getChildrenByName)
- [getComponent](./XRLight.html#getComponent)
- [release](./XRLight.html#release)
- [removeChild](./XRLight.html#removeChild)
- [removeComponent](./XRLight.html#removeComponent)
- [setAttribute](./XRLight.html#setAttribute)
- [setId](./XRLight.html#setId)
