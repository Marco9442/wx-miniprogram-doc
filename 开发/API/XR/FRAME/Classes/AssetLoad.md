[xr-frame](./../) / [Exports](./../modules.html) / AssetLoad

# [#](#Class-AssetLoad) Class: AssetLoad

用于加载资源的组件，一般被代理到[XRAssetLoad](./XRAssetLoad.html)元素。

## [#](#Hierarchy) Hierarchy

- [`Component`](./Component.html)<`IAssetLoadData`>
...
- [constructor](./AssetLoad.html#constructor)

### [#](#Events) Events

- [onAdd](./AssetLoad.html#onAdd)
- [onRelease](./AssetLoad.html#onRelease)
- [onRemove](./AssetLoad.html#onRemove)
- [onTick](./AssetLoad.html#onTick)
- [onUpdate](./AssetLoad.html#onUpdate)

### [#](#Properties) Properties

- [priority](./AssetLoad.html#priority)
- [schema](./AssetLoad.html#schema)
- [EVENTS](./AssetLoad.html#EVENTS)

### [#](#Accessors) Accessors

- [el](./AssetLoad.html#el)
- [scene](./AssetLoad.html#scene)
- [version](./AssetLoad.html#version)

### [#](#Methods) Methods

- [getData](./AssetLoad.html#getData)
- [setData](./AssetLoad.html#setData)
- [setDataOne](./AssetLoad.html#setDataOne)
...
详见[AssetLoadSchema](./../modules.html#AssetLoadSchema)。
