[xr-frame](./../) / [Exports](./../modules.html) / XRAssets

# [#](#Class-XRAssets) Class: XRAssets

标签为`xr-assets`。

默认组件见[AssetsDefaultComponents](./../modules.html#AssetsDefaultComponents)。
...
- [constructor](./XRAssets.html#constructor)

### [#](#Properties) Properties

- [dataMapping](./XRAssets.html#dataMapping)
- [defaultComponents](./XRAssets.html#defaultComponents)
- [neverTick](./XRAssets.html#neverTick)
- [TYPE](./XRAssets.html#TYPE)

### [#](#Accessors) Accessors

- [event](./XRAssets.html#event)
- [id](./XRAssets.html#id)
- [inXML](./XRAssets.html#inXML)
- [name](./XRAssets.html#name)
- [parent](./XRAssets.html#parent)
- [scene](./XRAssets.html#scene)

### [#](#Methods) Methods

- [addChild](./XRAssets.html#addChild)
- [addComponent](./XRAssets.html#addComponent)
- [dfs](./XRAssets.html#dfs)
- [getChildAtIndex](./XRAssets.html#getChildAtIndex)
- [getChildByClass](./XRAssets.html#getChildByClass)
- [getChildByFilter](./XRAssets.html#getChildByFilter)
- [getChildByName](./XRAssets.html#getChildByName)
- [getChildrenByFilter](./XRAssets.html#getChildrenByFilter)
- [getChildrenByName](./XRAssets.html#getChildrenByName)
- [getComponent](./XRAssets.html#getComponent)
- [release](./XRAssets.html#release)
- [removeChild](./XRAssets.html#removeChild)
- [removeComponent](./XRAssets.html#removeComponent)
- [setAttribute](./XRAssets.html#setAttribute)
- [setId](./XRAssets.html#setId)
