[xr-frame](./../) / [Exports](./../modules.html) / XREnv

# [#](#Class-XREnv) Class: XREnv

标签为`xr-env`。

默认组件见[EnvDefaultComponents](./../modules.html#EnvDefaultComponents)，属性映射见[EnvDataMapping](./../modules.html#EnvDataMapping)。
...
- [constructor](./XREnv.html#constructor)

### [#](#Properties) Properties

- [dataMapping](./XREnv.html#dataMapping)
- [defaultComponents](./XREnv.html#defaultComponents)
- [neverTick](./XREnv.html#neverTick)
- [TYPE](./XREnv.html#TYPE)

### [#](#Accessors) Accessors

- [event](./XREnv.html#event)
- [id](./XREnv.html#id)
- [inXML](./XREnv.html#inXML)
- [name](./XREnv.html#name)
- [parent](./XREnv.html#parent)
- [scene](./XREnv.html#scene)

### [#](#Methods) Methods

- [addChild](./XREnv.html#addChild)
- [addComponent](./XREnv.html#addComponent)
- [dfs](./XREnv.html#dfs)
- [getChildAtIndex](./XREnv.html#getChildAtIndex)
- [getChildByClass](./XREnv.html#getChildByClass)
- [getChildByFilter](./XREnv.html#getChildByFilter)
- [getChildByName](./XREnv.html#getChildByName)
- [getChildrenByFilter](./XREnv.html#getChildrenByFilter)
- [getChildrenByName](./XREnv.html#getChildrenByName)
- [getComponent](./XREnv.html#getComponent)
- [release](./XREnv.html#release)
- [removeChild](./XREnv.html#removeChild)
- [removeComponent](./XREnv.html#removeComponent)
- [setAttribute](./XREnv.html#setAttribute)
- [setId](./XREnv.html#setId)
