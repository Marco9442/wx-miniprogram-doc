[xr-frame](./../) / [Exports](./../modules.html) / GizmoSystem

# [#](#Class-GizmoSystem) Class: GizmoSystem

动画系统，负责为Gizmo组件创建管理相对应的GizmoMesh元素。

## [#](#Hierarchy) Hierarchy

- [`Component`](./Component.html)<[`IGizmoSystemData`](./../interfaces/IGizmoSystemData.html)>
...
- [constructor](./GizmoSystem.html#constructor)

### [#](#Events) Events

- [onAdd](./GizmoSystem.html#onAdd)
- [onRelease](./GizmoSystem.html#onRelease)
- [onRemove](./GizmoSystem.html#onRemove)
- [onTick](./GizmoSystem.html#onTick)
- [onUpdate](./GizmoSystem.html#onUpdate)

### [#](#Properties) Properties

- [priority](./GizmoSystem.html#priority)
- [schema](./GizmoSystem.html#schema)
- [EVENTS](./GizmoSystem.html#EVENTS)

### [#](#Accessors) Accessors

- [el](./GizmoSystem.html#el)
- [scene](./GizmoSystem.html#scene)
- [version](./GizmoSystem.html#version)

### [#](#Methods) Methods

- [getData](./GizmoSystem.html#getData)
- [setData](./GizmoSystem.html#setData)
- [setDataOne](./GizmoSystem.html#setDataOne)
...
▸ **getData**<`T`>(`key`): [`IGizmoSystemData`](./../interfaces/IGizmoSystemData.html)[`T`]
...
[`IGizmoSystemData`](./../interfaces/IGizmoSystemData.html)[`T`]
