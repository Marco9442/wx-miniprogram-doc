[xr-frame](./../) / [Exports](./../modules.html) / ShapeGizmos

# [#](#Class-ShapeGizmos) Class: ShapeGizmos

将当前元素下的所有[轮廓](./Shape.html)都显示出来。
在标签上添加`shape-gizmo`属性来创建该组件。

**`see`** [IShapeGizmosData](./../interfaces/IShapeGizmosData.html)

## [#](#Hierarchy) Hierarchy

- [`Component`](./Component.html)<[`IShapeGizmosData`](./../interfaces/IShapeGizmosData.html)>
...
- [constructor](./ShapeGizmos.html#constructor)

### [#](#Events) Events

- [onAdd](./ShapeGizmos.html#onAdd)
- [onRelease](./ShapeGizmos.html#onRelease)
- [onRemove](./ShapeGizmos.html#onRemove)
- [onTick](./ShapeGizmos.html#onTick)
- [onUpdate](./ShapeGizmos.html#onUpdate)

### [#](#Properties) Properties

- [priority](./ShapeGizmos.html#priority)
- [schema](./ShapeGizmos.html#schema)
- [EVENTS](./ShapeGizmos.html#EVENTS)

### [#](#Accessors) Accessors

- [el](./ShapeGizmos.html#el)
- [scene](./ShapeGizmos.html#scene)
- [version](./ShapeGizmos.html#version)

### [#](#Methods) Methods

- [getData](./ShapeGizmos.html#getData)
- [setData](./ShapeGizmos.html#setData)
- [setDataOne](./ShapeGizmos.html#setDataOne)
...
▸ **getData**<`T`>(`key`): [`IShapeGizmosData`](./../interfaces/IShapeGizmosData.html)[`T`]
...
[`IShapeGizmosData`](./../interfaces/IShapeGizmosData.html)[`T`]
