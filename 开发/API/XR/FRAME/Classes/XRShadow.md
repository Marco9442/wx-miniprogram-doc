[xr-frame](./../) / [Exports](./../modules.html) / XRShadow

# [#](#Class-XRShadow) Class: XRShadow

标签为`xr-shadow`。
是一种特殊的节点，开发者**仅可在其下以及子孙挂载自己创建的节点**！

默认组件见[ShadowDefaultComponents](./../modules.html#ShadowDefaultComponents)，属性映射见[ShadowDataMapping](./../modules.html#ShadowDataMapping)。
...
- [constructor](./XRShadow.html#constructor)

### [#](#Properties) Properties

- [dataMapping](./XRShadow.html#dataMapping)
- [defaultComponents](./XRShadow.html#defaultComponents)
- [TYPE](./XRShadow.html#TYPE)

### [#](#Accessors) Accessors

- [event](./XRShadow.html#event)
- [id](./XRShadow.html#id)
- [inXML](./XRShadow.html#inXML)
- [name](./XRShadow.html#name)
- [parent](./XRShadow.html#parent)
- [scene](./XRShadow.html#scene)

### [#](#Methods) Methods

- [addChild](./XRShadow.html#addChild)
- [addComponent](./XRShadow.html#addComponent)
- [dfs](./XRShadow.html#dfs)
- [getChildAtIndex](./XRShadow.html#getChildAtIndex)
- [getChildByClass](./XRShadow.html#getChildByClass)
- [getChildByFilter](./XRShadow.html#getChildByFilter)
- [getChildByName](./XRShadow.html#getChildByName)
- [getChildrenByFilter](./XRShadow.html#getChildrenByFilter)
- [getChildrenByName](./XRShadow.html#getChildrenByName)
- [getComponent](./XRShadow.html#getComponent)
- [release](./XRShadow.html#release)
- [removeChild](./XRShadow.html#removeChild)
- [removeComponent](./XRShadow.html#removeComponent)
- [setAttribute](./XRShadow.html#setAttribute)
- [setId](./XRShadow.html#setId)
