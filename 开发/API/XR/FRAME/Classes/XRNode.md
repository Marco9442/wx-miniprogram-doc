[xr-frame](./../) / [Exports](./../modules.html) / XRNode

# [#](#Class-XRNode) Class: XRNode

标签为`xr-node`，场景中所有3D节点的基础。

默认组件见[NodeDefaultComponents](./../modules.html#NodeDefaultComponents)，属性映射见[NodeDataMapping](./../modules.html#NodeDataMapping)。
...
- [constructor](./XRNode.html#constructor)

### [#](#Properties) Properties

- [dataMapping](./XRNode.html#dataMapping)
- [defaultComponents](./XRNode.html#defaultComponents)
- [isXRNode](./XRNode.html#isXRNode)
- [TYPE](./XRNode.html#TYPE)

### [#](#Accessors) Accessors

- [event](./XRNode.html#event)
- [id](./XRNode.html#id)
- [inXML](./XRNode.html#inXML)
- [name](./XRNode.html#name)
- [parent](./XRNode.html#parent)
- [scene](./XRNode.html#scene)

### [#](#Methods) Methods

- [addChild](./XRNode.html#addChild)
- [addComponent](./XRNode.html#addComponent)
- [dfs](./XRNode.html#dfs)
- [getChildAtIndex](./XRNode.html#getChildAtIndex)
- [getChildByClass](./XRNode.html#getChildByClass)
- [getChildByFilter](./XRNode.html#getChildByFilter)
- [getChildByName](./XRNode.html#getChildByName)
- [getChildrenByFilter](./XRNode.html#getChildrenByFilter)
- [getChildrenByName](./XRNode.html#getChildrenByName)
- [getComponent](./XRNode.html#getComponent)
- [release](./XRNode.html#release)
- [removeChild](./XRNode.html#removeChild)
- [removeComponent](./XRNode.html#removeComponent)
- [setAttribute](./XRNode.html#setAttribute)
- [setId](./XRNode.html#setId)
- [IS](./XRNode.html#IS)
