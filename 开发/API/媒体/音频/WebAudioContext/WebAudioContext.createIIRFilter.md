# [#](#IIRFilterNode-WebAudioContext-createIIRFilter-Array-number-feedforward-Array-number-feedback) IIRFilterNode WebAudioContext.createIIRFilter(Array.<number> feedforward, Array.<number> feedback)
...
### [#](#Array-number-feedforward) Array.<number> feedforward

一个浮点值数组，指定IIR滤波器传递函数的前馈(分子)系数。

### [#](#Array-number-feedback) Array.<number> feedback
