# [#](#Path2D-bezierCurveTo-number-cp1x-number-cp1y-number-cp2x-number-cp2y-number-x-number-y) Path2D.bezierCurveTo(number cp1x, number cp1y, number cp2x, number cp2y, number x, number y)
