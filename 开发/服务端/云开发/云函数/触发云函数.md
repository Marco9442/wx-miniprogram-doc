...
- 如果是服务商模式-批量代云开发，则使用 [component\_access\_token](https://developers.weixin.qq.com/doc/oplatform/openApi/ticket-token/api_getcomponentaccesstoken)；
- 如果是服务商模式-普通代云开发，则使用 [authorizer\_access\_token](https://developers.weixin.qq.com/doc/oplatform/openApi/ticket-token/api_getauthorizeraccesstoken)；
- 如果是小程序普通调用，则使用 [access\_token](../../mp-access-token/api_getaccesstoken)。
