...
| env\_id | string | 是 | [环境 ID](https://developers.weixin.qq.com/miniprogram/dev/wxcloudservice/wxcloud/basis/quickstart) |
...
### [#](#_5-1-sendSmsTask-请求数据示例) 5.1 sendSmsTask 请求数据示例
