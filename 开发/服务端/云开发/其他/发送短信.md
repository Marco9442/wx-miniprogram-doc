...
### [#](#Res-send-status-list-Array-Object-Payload) Res.send\_status\_list(Array) `Object Payload`
...
小程序需要将【短信服务】或【云开发】权限集授权给第三方，第三方才可代小程序调用此接口。第三方在调用接口时，可选择使用第三方的环境或小程序的环境，默认使用小程序的环境。在resource\_appid填入第三方的appid，在env填入第三方账号下的环境，即可使用第三方的环境。
...
### [#](#_5-1-营销类短信请求数据示例) 5.1 营销类短信请求数据示例
...
### [#](#_5-2-通知类短信请求数据示例) 5.2 通知类短信请求数据示例
