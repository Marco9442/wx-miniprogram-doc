...
### [#](#Res-finder-event-list-Array-Object-Payload) Res.finder\_event\_list(Array) `Object Payload`
...
3. 传入event\_id\_list用于筛选指定event\_id的推广活动，最大数量限制为50
