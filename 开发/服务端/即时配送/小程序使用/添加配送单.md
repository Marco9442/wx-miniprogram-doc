...
发件人信息，顺丰同城急送必须填写，美团配送、达达、闪送，若传了shop\_no的值可不填该字段
...
### [#](#Body-order-info-Object-Payload) Body.order\_info `Object Payload`
...
### [#](#Body-cargo-goods-detail-Object-Payload) Body.cargo.goods\_detail `Object Payload`
...
### [#](#Body-cargo-goods-detail-goods-Array-Object-Payload) Body.cargo.goods\_detail.goods(Array) `Object Payload`
...
### [#](#Body-cargo-cargo-first-class-Enum) Body.cargo.cargo\_first\_class `Enum`
...
- 如遇下单错误，请先确认一下编码方式，python建议 json.dumps(b, ensure\_ascii=False)，php建议 json\_encode($arr, JSON\_UNESCAPED\_UNICODE) 可预约时间：达达：72小时内，闪送2小时以后，48小时以内。
...
### [#](#_6-1-HTTPS调用成功实例) 6.1 HTTPS调用成功实例
...
### [#](#_6-2-HTTPS调用失败实例) 6.2 HTTPS调用失败实例
