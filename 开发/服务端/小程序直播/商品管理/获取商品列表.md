...
### [#](#Res-goods-Array-Object-Payload) Res.goods(Array) `Object Payload`
...
https://api.weixin.qq.com/wxaapi/broadcast/goods/getapproved?access\_token=[access\_token]& status=2
