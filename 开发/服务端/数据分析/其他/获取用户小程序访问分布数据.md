...
### [#](#Res-list-Array-item-list-Object-Payload) Res.list(Array).item\_list`Object Payload`
...
#### [#](#访问来源-key-对应关系（index-access-source-session-cnt-，场景值说明参见场景值) 访问来源 key 对应关系（index='access\_source\_session\_cnt')，场景值说明参见[场景值](https://developers.weixin.qq.com/miniprogram/dev/reference/scene-list)
...
#### [#](#访问来源-key-对应关系（index-access-staytime-info) 访问来源 key 对应关系（index='access\_staytime\_info')
...
#### [#](#平均访问深度-key-对应关系（index-access-depth-info-）) 平均访问深度 key 对应关系（index='access\_depth\_info'）
