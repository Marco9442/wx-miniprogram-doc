# [#](#logistics-onAddOrder) logistics.onAddOrder
...
| 属性 | 类型 | 说明 |
| --- | --- | --- |
| ServiceType | number | 服务类型ID，详见[已经支持的快递公司基本信息](https://developers.weixin.qq.com/miniprogram/dev/platform-capabilities/industry/express/business/qa) |
| ServiceName | string | 服务名称，详见[已经支持的快递公司基本信息](https://developers.weixin.qq.com/miniprogram/dev/platform-capabilities/industry/express/business/qa) |
...
比如样例`##ZTO_bagAddr##广州##ZTO_mark##888-666-666##`中，"ZTO\_markAddr"表示中通的集包地代号，"广州"是实际的集包地值；"ZTO\_mark"表示中通三段码代号，"888-666-666"是实际的三段码值。
