...
### [#](#Res-audit-detail-Object-Payload) Res.audit\_detail `Object Payload`

审核信息，区别于[getdrama接口](api_getdrama)的audit\_detail，getdrama接口的audit\_type仅表示audit\_type=0或1的审核信息。
