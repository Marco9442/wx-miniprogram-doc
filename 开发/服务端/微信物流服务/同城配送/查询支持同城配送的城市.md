# [#](#查询支持同城配送的城市) 查询支持同城配送的城市

> 接口应在服务器端调用，不可在前端（小程序、网页、APP等）直接调用，具体可参考[接口调用指南](https://developers.weixin.qq.com/doc/oplatform/developers/dev/guide)。

接口英文名：intracity\_getcity
...
### [#](#Res-support-list-Object-Payload) Res.support\_list `Object Payload`
...
### [#](#Res-support-list-city-list-Array-Object-Payload) Res.support\_list.city\_list(Array) `Object Payload`
