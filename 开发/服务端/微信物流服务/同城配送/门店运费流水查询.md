...
### [#](#Res-flow-list-Array-Object-Payload) Res.flow\_list(Array) `Object Payload`
...
### [#](#Body-service-trans-id-Enum) Body.service\_trans\_id `Enum`
...
### [#](#Res-flow-list-Array-delivery-status-Enum) Res.flow\_list(Array).delivery\_status `Enum`

运单状态，当flow\_type=2消费流水时返回
