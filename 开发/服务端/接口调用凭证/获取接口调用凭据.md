...
- 如使用[云开发](https://developers.weixin.qq.com/miniprogram/dev/wxcloudservice/wxcloud/basis/getting-started)，可通过[云调用](../openApi-mgnt/api_clearapiquota)免维护 access\_token 调用。
