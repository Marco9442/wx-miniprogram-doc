...
### [#](#Res-book-list-Array-Object-Payload) Res.book\_list(Array) `Object Payload`
...
### [#](#Res-book-list-Array-audit-info-Object-Payload) Res.book\_list(Array).audit\_info `Object Payload`
...
1. offset + limit 分页方式在作品数量超过10万时会失败，建议使用 last\_id + limit 分页方式
