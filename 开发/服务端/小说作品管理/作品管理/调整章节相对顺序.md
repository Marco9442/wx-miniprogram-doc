...
### [#](#Body-chapter-seq-list-Array-Object-Payload) Body.chapter\_seq\_list(Array) `Object Payload`
...
1. 该接口仅当作品“章节排序方式”为“seq 递增”时才生效，如需修改章节排序方式可调用“[编辑作品](api_updatebook)”接口。
