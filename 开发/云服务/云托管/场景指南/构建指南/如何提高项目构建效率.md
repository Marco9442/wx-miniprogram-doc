# [#](#如何提高项目构建效率) 如何提高项目构建效率

微信云托管服务是通过Docker镜像来启动的，也就是说你需要将你自己的业务项目代码打包成Docker镜像，才能在微信云托管中正常运行。

## [#](#业务项目代码打包成Docker镜像) 业务项目代码打包成Docker镜像

对于Docker，容器等概念全然不知的同学来讲，似乎很难理解什么是镜像，以及如何把代码变成镜像。建议可以先通过这个[视频教程](https://developers.weixin.qq.com/community/business/doc/0002e26df14a50f7bc8c139eb51c0d)有个大概了解后再来继续。
...
### [#](#_1-变化的放后面，高效利用缓存) 1. 变化的放后面，高效利用缓存
...
微信云托管线上构建的Docker镜像源已经是腾讯加速源了，所以不需要自己设置
...
这种Dockerfile以及相关概念本身不属于微信云托管的服务范畴，大部分情况下，主要依赖各位开发者提供优质的打包过程，我们才能够在部署构建过程中有显著的提速。
