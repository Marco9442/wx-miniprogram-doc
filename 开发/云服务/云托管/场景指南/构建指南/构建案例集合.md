...
此文档指向的[Github项目](https://github.com/WeixinCloud/DockerTemplate)

## [#](#一、项目清单) 一、项目清单

#### [#](#_1-Nginx-HTML分发模版) 1. [Nginx+HTML分发模版](https://github.com/WeixinCloud/DockerTemplate/tree/master/nginxdist)

如果你有vue或者其他打包的web的项目，需要使用nginx分发，可以参考此模版，将其中的dist文件夹内容替换成自己的项目内容。

Nginx分发配置，可以直接修改根目录的 `my.conf`

#### [#](#_2-Nginx-Node分发模版) 2. [Nginx+Node分发模版](https://github.com/WeixinCloud/DockerTemplate/tree/master/nginxnode)
...
#### [#](#_3-PHP中SG11扩展安装模版) 3. [PHP中SG11扩展安装模版](phpsg11)
...
#### [#](#_4-jetty应用模版) 4. [jetty应用模版](https://github.com/WeixinCloud/DockerTemplate/tree/master/jetty)
...
#### [#](#_5-Nginx-java-openjdk分发模版) 5. [Nginx+java-openjdk分发模版](https://github.com/WeixinCloud/DockerTemplate/tree/master/nginxjava/)
...
#### [#](#_6-Nginx-Node简易WebSocket) 6. [Nginx+Node简易WebSocket](https://github.com/WeixinCloud/DockerTemplate/tree/master/websocket/)
