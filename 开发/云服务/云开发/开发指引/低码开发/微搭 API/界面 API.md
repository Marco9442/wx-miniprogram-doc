...
显示 loading 提示框。支持 [promise 风格调用](https://developers.weixin.qq.com/miniprogram/dev/framework/app-service/api#API)。需主动调用 `app.hideLoading` 才能关闭提示框。
...
隐藏 loading 提示框。支持 [promise 风格调用](https://developers.weixin.qq.com/miniprogram/dev/framework/app-service/api#API)。需主动调用 `app.hideLoading` 才能关闭提示框。
...
显示模态对话框，支持 [promise 风格调用](https://developers.weixin.qq.com/miniprogram/dev/framework/app-service/api#API) 。
