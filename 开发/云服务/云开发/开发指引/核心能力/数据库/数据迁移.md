...
### [#](#使用云开发控制台导入) 使用云开发控制台导入

要导入数据，需打开云开发控制台，切换到「数据库」标签页，并选择要导入数据的集合，点击「导入」按钮。

![数据库](https://res8.wxqcloud.qq.com.cn/wxdoc/36c59e4c-23de-4f96-b2d4-1a7317be94d3.jpg)

选择要导入的 CSV 或者 JSON 文件，以及冲突处理模式，点击「导入」按钮即可开始导入。

### [#](#使用-HTTP-API-导入) 使用 HTTP API 导入

详情参考[HTTP API 数据库导入](../../reference-http-api/database/databaseMigrateImport)文档
...
![数据库](https://res8.wxqcloud.qq.com.cn/wxdoc/037f756e-d056-40b6-81c2-b455657e2107.jpg)
