...
使用数据库 API 提供的 `where` 方法我们可以构造复杂的查询条件完成复杂的查询任务。在本节中我们还是使用[上一章节](read)中使用的示例数据。
...
更多具体的查询指令 API 文档可参考[数据库 API 文档](../../reference-sdk-api/database/Command)。
...
具体的逻辑查询指令 API 文档可参考[数据库 Command API 文档](../../reference-sdk-api/database/Command)。
