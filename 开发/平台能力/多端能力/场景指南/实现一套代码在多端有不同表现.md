...
1. 目前支持 `wxml`、`wxss`、`js/ts`、`json`，`less/sass`，`wxss` 等文件类型，资源支持通过配置区分不同平台。
...
![](https://mmbiz.qpic.cn/mmbiz_png/PxLPibq1ibyh1W4Ma6ccUa33S5FviayHqCmj2WzP8S4OEz6cp9MTQgfM3ic1PyEVhziat76sDhiahOTrFnGIDV4S38iaw/0?wx_fmt=png)
...
3. `NATIVE` 与 `IOS || ANDROID` 等效（JSON 文件不适用）

### [#](#_2-1-WXML-文件) 2.1 WXML 文件
...
### [#](#_2-2-WXSS-文件（css-sass-less-适用）) 2.2 WXSS 文件（css/sass/less 适用）
...
### [#](#_2-3-JS-文件（TS-适用）) 2.3 JS 文件（TS 适用）
...
![](https://mmbiz.qpic.cn/mmbiz_png/PxLPibq1ibyh1W4Ma6ccUa33S5FviayHqCmqt9cnvUjOmCibBlmzUiarooo8SHocrB3kgoU5mibmZC6yrZiczQSMGlmPg/0?wx_fmt=png)

### [#](#_2-4-JSON-文件) 2.4 JSON 文件
