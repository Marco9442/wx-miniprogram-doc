...
| 参数名 | 类型 | 是否必填 | 参数说明 |
| --- | --- | --- | --- |
| appId | String | 是 | 填写 wxeb490c6f9b154ef9，固定为此 AppID |
...
`navigateToMiniProgram`接口已废弃，新版本中请使用[navigator](https://developers.weixin.qq.com/miniprogram/dev/component/navigator.html)组件来使用此功能
...
3）开卡组件是使用 wx.navigateToMiniProgram 开发的官方组件，跳转时无须绑定同一个公众号，直接调用即可
