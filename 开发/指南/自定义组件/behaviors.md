...
详细的参数含义和使用请参考 [Behavior 参考文档](https://developers.weixin.qq.com/miniprogram/dev/reference/api/Behavior)。
...
[在开发者工具中预览效果](https://developers.weixin.qq.com/s/Yq4RqCm87thO "在开发者工具中预览效果")
...
详细用法以及代码示例可见：[form 组件参考文档](https://developers.weixin.qq.com/miniprogram/dev/component/form.html)
