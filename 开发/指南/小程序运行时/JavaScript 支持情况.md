# [#](#JavaScript-支持情况) JavaScript 支持情况
...
## [#](#标准-ECMAScript-支持) 标准 ECMAScript 支持
...
### [#](#无法被-Polyfill-的-API) 无法被 Polyfill 的 API
...
## [#](#如何判断当前环境需要哪些-Polyfill-代码转换目标) 如何判断当前环境需要哪些 Polyfill & 代码转换目标
