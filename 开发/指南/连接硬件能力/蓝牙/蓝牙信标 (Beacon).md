...
- Beacon 相关接口可以直接使用，不需要使用 [wx.openBluetoothAdapter](https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/wx.closeBluetoothAdapter.html) 初始化蓝牙适配器模块
