...
| --- | --- | --- | --- | --- | --- |
| 0 | 刷脸模式（时长计费） | 微信支付刷脸返回的 user\_id | 微信用户 openId | 微信支付刷脸返回的 voip\_token |  |
...
| 属性 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| access\_token / cloudbase\_access\_token | string | 是 | [接口调用凭证](https://developers.weixin.qq.com/miniprogram/dev/server/API/mp-access-token/api_getaccesstoken) |
| user\_id | string | 是 | 学生 userId |
...
| errcode | number | 错误码 |
| errmsg | string | 错误信息 |
| contact\_list | ContactInfo[] | 联系人列表 |

**ContactInfo**

| 属性 | 类型 | 说明 |
| --- | --- | --- |
| open\_id | string | 联系人 openid |
