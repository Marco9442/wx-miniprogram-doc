...
### [#](#_1-2-安卓应用直接进入通话页面) 1.2 安卓应用直接进入通话页面
...
## [#](#_2-设备端发起通话（Linux-直连）) 2. 设备端发起通话（Linux 直连）

请参考 [《小程序音视频通话 SDK (Linux)》](voip-sdk#_5-4-通话) 5.4.1 发起通话部分

## [#](#_3-手机微信端接听通话) 3. 手机微信端接听通话
...
## [#](#_4-设备端处理通话结束（安卓直连）) 4. 设备端处理通话结束（安卓直连）
