...
### [#](#_2-4-微信视频编码定制方法) 2.4 微信视频编码定制方法
...
#### [#](#_2-5-1-微信响铃延时) 2.5.1 微信响铃延时

- wx\_cloudvoip\_client\_call 接口正常需要 600ms 左右。如果在 RTOS 设备上运行，根据不同的网络侧实现，接口的返回时间会有所不同。
- wx\_cloudvoip\_client\_call 接口返回成功后，微信侧即响铃。当然，对于不同的手机，延时情况会不一样。对于 iphone，还依赖于 apple 的消息推送，对于 android，各种系统设置还可能导致手机消息异常，可参考[通话提醒异常排查指南](notification)

#### [#](#_2-5-2-视频流延时) 2.5.2 视频流延时
