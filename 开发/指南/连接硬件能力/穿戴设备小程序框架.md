...
#### [#](#_2-1-1-组件框架) 2.1.1 组件框架

可以使用小程序中 Page、Component 能力。支持完整的 WXML、WXSS 语法。

##### [#](#_2-1-1-1-支持的特性) 2.1.1.1 支持的特性

可以在小程序中使用 App、getApp、Page、getCurrentPages、Component。支持 ES6 import / export 与 CommonJS require 两种 JS 模块加载机制。

##### [#](#_2-1-1-2-使用差异) 2.1.1.2 使用差异

使用小程序组件框架时应注意下列差异：

- 组件的 styleIsolation 需在 JSON 中配置，不支持在组件 options 中指定
- 不再支持 addGlobalClass，请使用 styleIsolation 代替
- 当使用[组件间通信与事件](../custom-component/events#%E8%87%AA%E5%AE%9A%E4%B9%89%E7%9A%84%E7%BB%84%E4%BB%B6%E5%AE%9E%E4%BE%8B%E8%8E%B7%E5%8F%96%E7%BB%93%E6%9E%9C)时，可以直接定义 export 属性，不需要声明 `wx://component-export`。

##### [#](#_2-1-1-3-暂未支持的特性) 2.1.1.3 暂未支持的特性

以下能力暂未支持

- [Chaining API](../custom-component/glass-easel/chaining-api)
- behavior
- WXS
...
#### [#](#_2-1-2-内置组件) 2.1.2 内置组件

目前仅支持下列内置组件

##### [#](#_2-1-2-1-view) 2.1.2.1 view

属性：无

##### [#](#_2-1-2-2-image) 2.1.2.2 image
...
##### [#](#_2-1-2-3-text) 2.1.2.3 text

属性：无

##### [#](#_2-1-2-4-qrcode) 2.1.2.4 qrcode
...
### [#](#_2-2-小程序配置) 2.2 小程序配置

#### [#](#_2-2-1-app-json) 2.2.1 app.json
...
| 属性 | 类型 | 必填 | 默认值 | 说明 |
| --- | --- | --- | --- | --- |
| request | number | 否 | 60\_000 | wx.request 的超时时间，单位：毫秒。 |

#### [#](#_2-2-2-component-json) 2.2.2 component.json
...
#### [#](#_2-2-3-page-json) 2.2.3 page.json
...
#### [#](#_2-3-1-微信生态能力) 2.3.1 微信生态能力

- wx.login：一致
- wx.checkSession: 一致
- wx.getAccountInfoSync：一致

#### [#](#_2-3-2-系统信息) 2.3.2 系统信息
...
### [#](#_3-1-注册穿戴设备小程序框架专属-AppID) 3.1 注册穿戴设备小程序框架专属 AppID
...
### [#](#_3-3-启用低功耗小程序模式) 3.3 启用低功耗小程序模式
