...
## [#](#_4-设备认证（Linux）) 4. 设备认证（Linux）

- 使用「小程序音视频通话 SDK（直连 Linux 设备）」的设备，请使用[wx\_device\_register](voip/voip-sdk)注册设备。
