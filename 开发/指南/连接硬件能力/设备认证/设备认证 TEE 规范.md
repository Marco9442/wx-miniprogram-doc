...
|  |  |
| --- | --- |
| 命令 | TA\_DEVAUTH\_CMD\_READ 0x10 |
| 功能 | 读 1 个 Block 的数据 |
...
|  |  |
| --- | --- |
| 命令 | TA\_DEVAUTH\_CMD\_WRITE 0x11 |
| 功能 | 写 1 个 Block 的数据 |
...
|  |  |
| --- | --- |
| 命令 | TA\_DEVAUTH\_CMD\_PROKEY 0x12 |
| 功能 | 写密钥 |
| 参数 | 密钥 BUFFER，=32字节 |
...
前置条件：**ta\_deauth 所管理的区域无任何数据**，再按顺序进行以下测试项。
