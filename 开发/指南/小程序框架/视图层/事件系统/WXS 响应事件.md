...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/63fca423-8162-4507-880d-22af6a997c54.png)
...
| triggerEvent | (eventName, detail) | 和组件的[triggerEvent](../custom-component/events)一致。 |  |
...
1. 目前还不支持[原生组件](https://developers.weixin.qq.com/miniprogram/dev/component/canvas.html)的事件、[input](https://developers.weixin.qq.com/miniprogram/dev/component/input.html)和[textarea](https://developers.weixin.qq.com/miniprogram/dev/api/device/keyboard/wx.getSelectedTextRange.html)组件的 bindinput 事件
