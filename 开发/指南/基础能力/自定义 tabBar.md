...
### [#](#_2-添加-tabBar-代码文件) 2. 添加 tabBar 代码文件
...
### [#](#_3-编写-tabBar-代码) 3. 编写 tabBar 代码
...
## [#](#skyline-模式) skyline 模式

使用 skyline 渲染模式的时候，需要进行如下适配：

### [#](#_1-tabBar-组件样式兼容) 1. tabBar 组件样式兼容
...
### [#](#_2-getTabBar-回调函数) 2. getTabBar 回调函数
