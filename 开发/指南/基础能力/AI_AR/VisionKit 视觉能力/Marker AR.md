# [#](#_2D-3D物体AR能力-（2D-3D-Marker-AR）) 2D/3D物体AR能力 （2D/3D Marker AR）
...
## [#](#_3D-Marker-识别目标文件-map-生成) 3D Marker 识别目标文件 map 生成
...
### [#](#_3D-Marker-来源视频参考) 3D Marker 来源视频参考

![demo-marker3d](https://res.wx.qq.com/wxdoc/dist/assets/img/marker3d-example.8ae1db23.gif)

## [#](#程序示例) 程序示例

以下接口可在 小程序接口能力展示demo 中的 **接口 - VisionKit视觉能力** 中体验

### [#](#_2D-Marker-能力) 2D Marker 能力
...
#### [#](#_3D-Marker案例-默认识别-大致效果) 3D Marker案例 默认识别 大致效果

![demo-marker3d](https://res.wx.qq.com/wxdoc/dist/assets/img/marker3d-example-lmc.95e2d66b.gif)

#### [#](#_3D-Marker案例-默认识别-来源视频参考) 3D Marker案例 默认识别 来源视频参考

![demo-marker3d](https://res.wx.qq.com/wxdoc/dist/assets/img/marker3d-example-lmcs.2289c6d1.gif)

#### [#](#_3D-Marker案例-默认识别-图片) 3D Marker案例 默认识别 图片
