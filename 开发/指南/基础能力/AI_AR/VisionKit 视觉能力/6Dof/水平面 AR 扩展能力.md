...
### [#](#虚实遮挡能力-暂不建议使用，待优化) 虚实遮挡能力 `(暂不建议使用，待优化)`

#### [#](#虚实遮挡-初始化开启，不支持多扩展混用) 虚实遮挡 初始化开启，不支持多扩展混用
...
#### [#](#虚实遮挡-动态开启与关闭，支持多扩展混用) 虚实遮挡 动态开启与关闭，支持多扩展混用
...
![plane+marker](https://res8.wxqcloud.qq.com.cn/wxdoc/db5c1c6b-5c9b-438e-a374-2e25d114849b.png)
