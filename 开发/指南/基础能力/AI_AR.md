...
示例使用 ONNX 官方 modelzoo 所提供的 mobileNetV2 模型。相关模型可以从[官方 GitHub](https://github.com/onnx/models/blob/main/vision/classification/mobilenet/model/mobilenetv2-12.onnx) 获取；示例中使用的前后处理方式也与 ONNX 官方给出的[imagenet\_validation](https://github.com/onnx/models/blob/main/vision/classification/imagenet_validation.ipynb)一致。

### [#](#_1-创建session) 1 创建session
...
### [#](#_2-session推理) 2 session推理

#### [#](#_2-1-处理摄像头采集数据) 2.1 处理摄像头采集数据
...
#### [#](#_2-2-对摄像头的采集数据进行前处理) 2.2 对摄像头的采集数据进行前处理
...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/1e3af6a1-441b-424f-9113-1be60e28990b.jpg)
...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/ab23ec57-a2d8-4888-8a2e-7fd485c9a20f.jpeg)
