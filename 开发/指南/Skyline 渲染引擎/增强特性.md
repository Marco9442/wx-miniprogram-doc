...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/5a3f2765-d1c9-4c03-9fec-8c71b3b62b70.png)

首先，我们需要了解一些相关概念。

## [#](#概念一：worklet-函数) 概念一：`worklet` 函数

一种声明在开发者代码中，可运行在 `JS` 线程或 `UI` 线程的函数，函数体顶部有 `'worklet'` 指令声明。

### [#](#worklet-函数定义) worklet 函数定义
...
### [#](#worklet-函数间相互调用) worklet 函数间相互调用
...
### [#](#从-UI-线程调回到-JS-线程) 从 UI 线程调回到 JS 线程
...
`worklet` 函数和共享变量就是用来解决交互动画问题的。相关接口 `applyAnimatedStyle` 可通过页面/组件实例访问，[接口文档参考](https://developers.weixin.qq.com/miniprogram/dev/reference/api/Component#applyAnimatedStyle-参数定义)。
...
- 页面实例方法 [applyAnimatedStyle](https://developers.weixin.qq.com/miniprogram/dev/reference/api/Component#applyAnimatedStyle-参数定义)、[clearAniamtedStyle](https://developers.weixin.qq.com/miniprogram/dev/reference/api/Component#clearAnimatedStyle-参数定义)
