...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/cfeed5ed-4395-4adf-8750-06867450f26c.gif)

扫码小程序示例，分别体验 `基础手势` 和 `协商手势` 新特性

![](https://res8.wxqcloud.qq.com.cn/wxdoc/fad0104e-ddb0-494b-9a24-60e44a957d31.png) ![](https://res8.wxqcloud.qq.com.cn/wxdoc/43ddd8a8-0e74-4896-a074-fa51ac44c377.png)
...
#### [#](#worklet-should-response-on-move) `worklet:should-response-on-move`
...
#### [#](#worklet-should-accept-gesture) `worklet:should-accept-gesture`
...
#### [#](#worklet-ongesture) `worklet:ongesture`
...
#### [#](#pan-vertical-drag-horizontal-drag) pan / vertical-drag / horizontal-drag
...
### [#](#Chaining-API-init-函数示例代码) Chaining API init 函数示例代码

[在开发者工具中预览效果](https://developers.weixin.qq.com/s/d9ChR5mt77St)

### [#](#示例一：监听拖动手势) 示例一：监听拖动手势
