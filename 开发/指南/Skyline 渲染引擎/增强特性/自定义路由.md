...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/6b2667b0-7b02-4fdc-8f1e-2f05ec0b6ffc.gif)

扫码打开小程序示例，交互动画 - 基础组件 - 自定义路由 即可体验。

![](https://res.wx.qq.com/op_res/1tPmq3hxyTRI5e3ch-tBB0bLYk7Zo2JnBwBWJceCRfMSXrg5Mwnpg3lMZNlUJJ_ago16Vjy76doh-7jS5ObRig)
...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/20a92e83-52ae-4531-a504-94df81e9a14f.png)

路由前后页面分别记为 `A` 页和 `B` 页，需要分别为其注册自定义路由。**未注册任何自定义路由效果时，新打开的页面 `B` 会立即覆盖显示在 `A` 页上。**

### [#](#Step-1-页面进入动画) Step-1 页面进入动画
...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/32529a48-5a1f-4c12-8fc4-1d3fd76ae612.gif)

### [#](#Step-2-自定义动画曲线) Step-2 自定义动画曲线
...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/613b58b2-58f3-44ee-a1a2-c94770c4ee94.gif)

### [#](#Step-3-页面联动效果) Step-3 页面联动效果
...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/7646c1f0-7f09-426e-95d3-eddcea6224c6.gif)

页面是否联动还可通过 `canTransitionTo` 和 `canTransitionFrom` 两个属性进行配置，可在开发者工具上修改体验。

### [#](#Step-4-手势返回) Step-4 手势返回
...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/0442f64e-b694-424c-af49-c50cdef6b37d.gif)

## [#](#设置页面透明) 设置页面透明

一些自定义路由效果下，需要实现页面透明背景，这里对 `Skyline` 和 `webview` 模式下背景色的层级关系进行说明。

### [#](#自定义路由下的页面背景色) 自定义路由下的页面背景色
...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/49d45287-f236-4209-9577-442f6ebe08d6.png)
...
### [#](#webview-下的页面背景色) webview 下的页面背景色
...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/ce6fcc80-ccfe-40b8-bb65-44233b049add.png)
