# [#](#小程序聊天工具模式开发指南Beta) 小程序聊天工具模式开发指南Beta
...
### [#](#_3-聊天成员相关能力) 3. 聊天成员相关能力

#### [#](#_3-1-获取相关id接口) 3.1 获取相关id接口
...
#### [#](#_3-3-渲染聊天成员的头像昵称) 3.3 渲染聊天成员的头像昵称
...
#### [#](#_5-1-创建activity-id) 5.1 创建activity\_id

服务端通过[创建activity\_id接口](https://developers.weixin.qq.com/miniprogram/dev/server/API/mp-message-management/updatable-message/api_createactivityid)创建activity\_id

#### [#](#_5-2-声明分享卡片为动态消息) 5.2 声明分享卡片为动态消息
...
#### [#](#_5-3-更新活动状态或用户完成情况) 5.3 更新活动状态或用户完成情况
...
### [#](#_6-聊天工具模式内禁用的能力) 6. 聊天工具模式内禁用的能力
