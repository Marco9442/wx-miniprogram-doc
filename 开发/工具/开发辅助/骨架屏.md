...
下载并安装 [1.03.2006032](log#nightly) 或 [1.04.2006032](log#nightly) 以上版本的开发者工具

## [#](#使用方法) 使用方法

工具可以为**当前正在预览的页面**生成骨架屏代码。工具入口位于模拟器面板右下角三点处。

![骨架屏入口](https://res8.wxqcloud.qq.com.cn/wxdoc/fefe864e-d3d7-4dbb-85f2-24c533b52ead.png)

点击生成骨架屏，将有弹窗提示是否允许插入骨架屏代码。确定后将在当前页面同级目录下生成 `page.skeleton.wxml` 和 `page.skeleton.wxss` 两个文件，分别为骨架屏代码的模板和样式。

![提示](https://res8.wxqcloud.qq.com.cn/wxdoc/e114da4f-d55f-4542-84f1-6d81ee5310f8.png)

骨架屏代码通过小程序模板（[template](https://developers.weixin.qq.com/miniprogram/dev/reference/wxml/template)）的方式引入 以 `pages/index/index` 页面为例，引入方式如下。
...
![](https://res8.wxqcloud.qq.com.cn/wxdoc/d7c8a928-3c20-48ef-82be-7f4b8f5eb374.gif)
