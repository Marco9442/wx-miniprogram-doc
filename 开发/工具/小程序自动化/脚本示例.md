...
按照[快速开始](quick-start)中的使用说明安装符合要求的开发者工具版本及打开安全设置 CLI/HTTP 调用功能后就可以开始编写脚本了。

## [#](#脚本编写) 脚本编写

现在我们准备为小程序示例的首页编写测试用例，如下图所示：

![miniprogram-demo-index](https://res8.wxqcloud.qq.com.cn/wxdoc/d02592da-52a7-46d2-accc-4e9d9fe50a60.jpg)
